...
urlpatterns = [
    ...
    path('order/<str:order_number>/cancel/', views.cancel_order, name='cancel_order'),  # Додаткова функція
    
    # Список бажань
    path('wishlist/', views.wishlist, name='wishlist'),
    path('wishlist/add/', views.add_to_wishlist, name='add_to_wishlist'),
    path('wishlist/remove/', views.remove_from_wishlist, name='remove_from_wishlist'),  # Додаткова функція
    path('wishlist/clear/', views.clear_wishlist, name='clear_wishlist'),  # Додаткова функція
    
    # Відгуки
    re_path(r'^product/(?P<product_slug>[\w\-]+)/review/add/$', views.add_review, name='add_review'),
    path('review/<int:review_id>/edit/', views.edit_review, name='edit_review'),  # Додаткова функція
    path('review/<int:review_id>/delete/', views.delete_review, name='delete_review'),  # Додаткова функція
    
    # Пошук
    path('search/', views.search, name='search'),
    path('search/autocomplete/', views.search_autocomplete, name='search_autocomplete'),  # Додаткова функція
